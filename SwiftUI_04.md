...
* idealSize는 부모 뷰의 공간과 관계없이 자신에게 가장 이상적인 idealSize를 가지고 있다. 그리고 fixedSize()를 이용하면 이 크기 정보를 활용 할 수 있다. 본질사이즈를 idealWidth, idealHeight로 설정하고 fixedSize() 수식어를 호출하면 고유 사이즈를 수정 할 수 있다.
